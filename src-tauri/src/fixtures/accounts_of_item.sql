INSERT INTO plaid_item (item_id, access_token) VALUES
    ('item-1', 'access-token-1'),
    ('item-2', 'access-token-2');
...
INSERT INTO account (id, plaid_account_id, name, bank_id, account_type) VALUES
    (1, 'plaid-acct-1', 'Primary Checking', 1, 'CHECKINGS'),
    (2, 'plaid-acct-2', 'Emergency Fund', 1, 'SAVINGS'),
    (3, 'plaid-acct-3', 'Joint Checking', 2, 'CHECKINGS'),
    (4, NULL, 'Manual Savings', 1, 'SAVINGS');
